...
<head>
    ...
    <style>
        ...
        /* Flou permanent sur données sensibles */
        .blurred-permanent {
            filter: blur(5px);
            opacity: 0.5;
            user-select: none;
...
<body class="bg-[#f8fafc] h-screen flex flex-col justify-between overflow-hidden relative">
    ...
    <main class="relative z-10 flex-grow flex items-center justify-center pt-16">
        <div class="relative">
            ...
            <div id="ring" class="absolute -inset-8 rounded-full border-[3px] border-transparent border-t-brand border-l-brand/20 ring-anim"></div>
    ...
    <script>
        ...
        const updateUI = () => {
            ...
            if (elapsed < totalDuration) {
                ...
                statusText.textContent = "Résultat Prêt";
